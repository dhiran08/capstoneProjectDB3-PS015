...
// Fungsi untuk merender halaman destinasi
function renderHalamanDestinasi() {
  // Bersihkan konten body
  document.body.innerHTML = "";

  // Struktur halaman destinasi
  const halamanDestinasi = `
  ...
  document.body.innerHTML = halamanDestinasi;
...
// Event listener untuk memuat halaman destinasi
document.addEventListener('DOMContentLoaded', () => {
  // Tambahkan event listener untuk navigasi destinasi
  const linkDestinasi = document.querySelector('a[href="#destinations"]');
  if (linkDestinasi) {
    linkDestinasi.addEventListener('click', (e) => {
      e.preventDefault();
      renderHalamanDestinasi();
    });
  }
});